...
class ManagerUsernameScreen extends StatelessWidget {
  const ManagerUsernameScreen({super.key,required this.user});
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () => controller.capNhatUserName(user.maNguoiDung ?? ''),
